...
## App Description
A reactive, real-time todo list application where users can create, complete, and delete tasks. Changes sync instantly across all open browser tabs via Electric SQL.
